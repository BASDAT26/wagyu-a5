    ...
    <section className="py-32 bg-black border-b border-white/10">
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-16 gap-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-medium text-white mb-4 tracking-tight" style={{ letterSpacing: "-0.03em" }}>
              Featured Events
            </h2>
          ...
          >
            <Link to="/event" className="inline-flex items-center gap-2 text-sm text-white/70 hover:text-white transition-colors group pb-1 border-b border-white/20 hover:border-white">
