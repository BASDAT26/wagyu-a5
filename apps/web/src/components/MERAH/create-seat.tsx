      ...
      <ModalContent className="max-w-md rounded-2xl">
        ...
        <ModalBody className="space-y-4 py-2">
          <div className="space-y-2">
                      <Label className="text-[11px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider">Venue</Label>
        ...
        <ModalFooter className="flex w-full gap-3 mt-4 sm:space-x-0">
          ...
          <Button className="flex-1 bg-blue-500 hover:bg-blue-600 text-white rounded-xl h-10 font-medium" onClick={() => setOpen(false)}>
            Tambah
          </Button>
        </ModalFooter>
      </ModalContent>
