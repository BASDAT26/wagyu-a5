    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-6">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-slate-500">Silakan login terlebih dahulu untuk melihat profil.</p>
          <button onClick={() => window.location.href = "/login"} className="px-6 py-2 bg-blue-600 text-white rounded-xl font-bold text-sm shadow-lg shadow-blue-500/20">Login Sekarang</button>
        </div>
      </div>
    );
  }
            ...
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="relative mb-6">
                  ...
                  <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-emerald-500 border-4 border-white dark:border-slate-900 rounded-full shadow-lg" title="Online" />
                </div>
                
                <h2 className="text-xl font-black text-slate-800 dark:text-slate-100 mb-1">{session.user.name}</h2>
                <div className="flex items-center gap-2 mb-6">
                  <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                    role === "ADMIN" ? "bg-red-100 text-red-600 border border-red-200" :
                    role === "ORGANIZER" ? "bg-purple-100 text-purple-600 border border-purple-200" :
                ...
                <div className="w-full space-y-2">
                  <button className="w-full flex items-center justify-between p-4 rounded-2xl bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 font-bold text-sm group/item">
                    ...
                    <ChevronRight size={16} className="opacity-50 group-hover/item:translate-x-1 transition-transform" />
                  </button>
                  <button className="w-full flex items-center justify-between p-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800/50 text-slate-600 dark:text-slate-400 font-bold text-sm group/item transition-colors">
                    ...
                    <ChevronRight size={16} className="opacity-0 group-hover/item:opacity-50 group-hover/item:translate-x-1 transition-all" />
                  </button>
                  <button className="w-full flex items-center justify-between p-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800/50 text-slate-600 dark:text-slate-400 font-bold text-sm group/item transition-colors">
                    <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/40 dark:shadow-none overflow-hidden">
              <div className="p-8 lg:p-10 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/20">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-slate-800 dark:text-slate-100">Detail Profil</h3>
                    <p className="text-xs font-medium text-slate-400">Informasi identitas Anda di platform</p>
                  </div>
                </div>
                {!isEditing ? (
                  <button 
              ...
              <div className="p-8 lg:p-10 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block ml-1">Email Utama</label>
                    <div className="relative">
                      <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                        <Mail size={18} />
                      </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/40 dark:shadow-none overflow-hidden">
              <div className="p-8 lg:p-10 border-b border-slate-100 dark:border-slate-800 flex items-center gap-4 bg-slate-50/50 dark:bg-slate-800/20">
                ...
                <div>
                  <h3 className="text-xl font-black text-slate-800 dark:text-slate-100">Keamanan</h3>
                  <p className="text-xs font-medium text-slate-400">Kelola kata sandi dan proteksi akun</p>
                </div>
              </div>
              ...
              <div className="p-8 lg:p-10 space-y-8">
                 <div className="space-y-6 max-w-xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block ml-1">Konfirmasi</label>
                        <input 
                          type="password" 
            ...
            <div className="p-8 lg:p-10 bg-red-50/50 dark:bg-red-900/10 rounded-[2.5rem] border border-red-100 dark:border-red-900/30 flex flex-col md:flex-row items-center justify-between gap-6">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-red-600/60">Semua data Anda akan dihapus permanen. Tindakan ini tidak dapat dibatalkan.</p>
                  </div>
               </div>
               <button className="px-6 py-3 border-2 border-red-200 dark:border-red-900/50 text-red-600 rounded-2xl text-xs font-black hover:bg-red-600 hover:text-white transition-all active:scale-95">Hapus Akun Saya</button>
            </div>
