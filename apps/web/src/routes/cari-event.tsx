...
const EVENTS = [
  {
    ...
    color: "bg-blue-500",
    image:
      "https://images.unsplash.com/photo-1540039155733-d7696d4eb98b?q=80&w=600&auto=format&fit=crop",
  },
  {
    id: "evt_2",
  ...
  },
  {
    ...
    color: "bg-rose-500",
    image:
      "https://images.unsplash.com/photo-1507676184212-d0330a151f96?q=80&w=600&auto=format&fit=crop",
  },
];
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {EVENTS.map((evt) => (
              <div
                key={evt.id}
                className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-blue-200 dark:hover:border-blue-900/50 transition-all group flex flex-col"
              >
                {/* Image cover */}
                ...
                <div className="p-6 flex flex-col flex-1">
                  <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-4 line-clamp-2">
                    {evt.title}
                  </h3>
