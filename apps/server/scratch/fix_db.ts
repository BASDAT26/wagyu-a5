...
async function fixSchema() {
  try {
    ...
    const checkPromo = await query(
      "SELECT column_name FROM information_schema.columns WHERE table_schema = 'tiktaktuk' AND table_name = 'promotion' AND column_name = 'usage_count';",
    );
